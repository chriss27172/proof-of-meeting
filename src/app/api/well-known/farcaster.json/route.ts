...
export async function GET() {
  ...
  // Farcaster/BaseApp miniapp manifest - wymagany dla rozpoznania aplikacji jako miniapp
  const farcasterManifest: any = {
    ...
    // UWAGA: Zastąp te wartości prawdziwymi z twojego konta Farcaster
    accountAssociation: {
    ...
    miniapp: {
      ...
      requiredCapabilities: ['actions.ready', 'actions.signIn', 'actions.authenticate'],
      screenshotUrls: [
